        ...
        <div className="p-3.5">
          <div className="grid gap-3 sm:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)_minmax(0,1fr)_auto]">
            <label className="grid gap-1">
              <span className="text-[12px] font-medium text-muted">{t("emailAriaLabel")}</span>
              <input
                type="email"
                value={email}
            ...
            <label className="grid gap-1">
              <span className="text-[12px] font-medium text-muted">{t("nameAriaLabel")}</span>
              <input
                type="text"
                value={name}
            ...
            <label className="grid gap-1">
              <span className="text-[12px] font-medium text-muted">{t("roleAriaLabel")}</span>
              <select
                value={role}
            ...
            <ul className="space-y-1">
              {rows.map((u) => {
                ...
                return (
                  <li
                    key={u.id}
                    className="flex flex-wrap items-center gap-2 rounded-lg bg-elevated px-2.5 py-2 text-[12px]"
                  >
                    <span
