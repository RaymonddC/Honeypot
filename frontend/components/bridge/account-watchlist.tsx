      ...
      <div className="flex items-center justify-between border-b border-line px-3.5 py-2.5">
        ...
        {items.length > 0 && (
          <span
            ...
            title="How many tracked accounts appear in the current bridge flow"
          >
            {inFlow}/{items.length} in flow
          </span>
        )}
      </div>
      ...
      <div className="p-2">
        {items.length === 0 ? (
          <p className="px-1.5 py-2 text-[11px] leading-relaxed text-muted">
            No tracked accounts yet. Add them from the{" "}
            <b className="text-white/60">Case File → Overview</b> or at{" "}
            <b className="text-white/60">Intake</b> — they’ll light up here when
              ...
              >
                ...
                {a.seen_in_flow ? (
                  ...
                  <span
                    ...
                    title="Tracked, but not seen in the current flow yet"
                  >
                    watch
                  </span>
                )}
