...
degrades gracefully). **493 backend tests green.** Case-centric hub
...
| **[Backlog.md](Backlog.md)** | The living "what we're aiming for" board — prioritized, gated vs actionable. |
